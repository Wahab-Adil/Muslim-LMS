              ...
              <div class="">
                ...
                <form>
                  <input
                    ...
                    type="text"
                    class="w-full h-14 shadow-sm text-gray-600 placeholder-text-400 text-lg font-normal leading-7 rounded-md border-2 border-indigo-600 focus:outline-none py-2 px-4 mb-8"
                  ...
                  <input
                    ...
                    class="w-full h-14 shadow-sm text-gray-600 placeholder-text-400 text-lg font-normal leading-7 rounded-md border border-gray-200 focus:outline-none py-2 px-4 mb-8"
                  ...
                  ></textarea>
                  <button class="w-full h-12 text-center text-white text-base font-semibold leading-6 rounded-md bg-indigo-600 shadow transition-all duration-700 hover:bg-indigo-800">
                    {translate("Send")}
                  </button>
                </form>
              </div>
