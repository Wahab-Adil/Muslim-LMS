...
const Testimonials = () => {
  ...
  return (
    <div class=" p-4 mb-6 bg-white rounded-lg shadow dark:bg-gray-800 sm:inline-block">
        ...
        <div class="flex-shrink-0">
          <div class="relative inline-block">
            ...
            <svg
              ...
              viewBox="0 0 20 20"
              class="absolute bottom-0 right-0 w-6 h-6 p-1 -mx-1 -my-1 text-white bg-green-600 rounded-full fill-current"
            >
