...
import { ArticleDeleteReview } from "../../store/features/article/reviews/articleReviewsSlice";
...
const ReviewCard = ({ review, ArticleDetails, articleId }) => {
  const dispatch = useDispatch();
  const [open, setOpen] = useState(false);
  const [id, setId] = useState();

  const deleteReview = (id) => {
    dispatch(ArticleDeleteReview(id));
