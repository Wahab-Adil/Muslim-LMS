...
import { Video_DeleteReview } from "../../store/features/video/reviews/videoReviewsSlice";
...
const ReviewCard = ({ review, Video_CourseDetails, CourseId }) => {
  const dispatch = useDispatch();
  const [open, setOpen] = useState(false);
  const [id, setId] = useState();

  const deleteReview = (id) => {
    dispatch(Video_DeleteReview(id));
      ...
      >
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-slide-description">
            Are You Sure To Delete Course Review
          </DialogContentText>
        </DialogContent>
        <DialogActions>
