export default {
  ...
  "advertisement Selected.": "آگهی انتخاب شده",
  ...
  "category updated successfully.": "دسته با موفقیت به روز شد",

  "Article not found.": "مقاله یافت نشد",
  "You Have already reviewed": "شما قبلا بررسی کرده اید",
  "You can't delete this review": "شما نمی توانید این بررسی را حذف کنید",
  "Review Deleted Successfully.": "بررسی با موفقیت حذف شد",
  "You can't edit this review": "شما نمی توانید این بررسی را ویرایش کنید",
  "Review Updated Successfully.": "بررسی با موفقیت به روز شد",
  "Review not found.": "بررسی یافت نشد",
  "Reviews Feachted Successfully.": "نظرات با موفقیت ارائه شد",

  "Review Not Found.": "نظر یافت نشد",
  "Review Already Selected.": "نظر از قبل انتخاب شده است",
  "Review Selected.": "نظر انتخاب شد",
  "Review Deleted.": "نظر حذف شد",
  "Reviews Fetched.": "نظرات واکشی شد",
  ...
  "You already reviewed Course.": "شما قبلاً دوره اموزشی را نظر داده اید",
  "review created successfull.": "نظر با موفقیت ایجاد شد",
  ...
  "Video added to section": "ویدیو به بخش اضافه شد",
  "Video Removed From section": "ویدیو از بخش حذف شد",
  "Video Fetched from section": "ویدیو از بخش واکشی شد",

  "User already exists.": "کاربر از قبل وجود دارد",
  "User Registered Successfull": "ثبت نام کاربر با موفقیت انجام شد",
  "Invalid login details": "جزئیات ورود نا معتبر است",
  "Email and password do not match": "ایمیل و رمز عبور مطابقت ندارند",
  "Successfull login": "ورود موفقیت آمیز",
  "user profile": "مشخصات کاربر",
  "Instructor profile": "مشخصات مربی",
  "please login first": "لطفا ابتدا وارد شوید",
  "Incorrect old password": "رمز عبور قدیمی اشتباه است",
  "Password changed successfully": "رمز عبور با موفقیت تغییر کرد",
  "You can't use this email": "شما نمی توانید از این ایمیل استفاده کنید",
  "Profile updated successfully": "نمایه با موفقیت به روز شد",
  "Please select an image": "لطفا یک تصویر را انتخاب کنید",
  "Profile picture updated successfully": "تصویر نمایه با موفقیت به روز شد",
  "Email has been sent to": "ایمیل به",
  ...
  "Course Review deleted successfully": "نقد دوره با موفقیت حذف شد",
  "Course Review updated successfully": "نقد دوره با موفقیت به‌روزرسانی شد",

  // Article
  "Article created successfully": "مقاله با موفقیت ایجاد شد",
  "Article deleted successfully": "مقاله با موفقیت حذف شد",
  "Article updated successfully": "مقاله با موفقیت به‌روزرسانی شد",
  "Section Added successfully": "بخش با موفقیت اضافه شد",
  "Section Deleted successfully": "بخش با موفقیت حذف شد",

  // Global Review
  "Review selected.": "نقد انتخاب شد",
  "Review deleted.": "نقد حذف شد",
  ...
  "Video Course deleted successfully": "دوره ویدیویی با موفقیت حذف شد",
  "Video Course updated successfully": "دوره ویدیویی با موفقیت به‌روزرسانی شد",
