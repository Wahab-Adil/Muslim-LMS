...
export default function ManageCourses() {
  ...
  const AllCourses = data?.category?.courses;
  ...
  // Search
  useEffect(() => {
    dispatch(FILTER_DATA({ Data: AllCourses, search }));
  }, [AllCourses, search, dispatch]);
      ...
      >
        ...
        <DialogActions>
          ...
          <Button
            ...
            onClick={async () => {
              handleClose();
              await dispatch(Video_DeleteCourse(CourseId));
              dispatch(Video_SingleCategory(id));
            }}
          >
            Delete
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
              <div class="flex-1 flex items-center space-x-2">
                <h5>
                  ...
                  {currentItems?.length})
                  <span class="text-gray-500"> From Courses</span>
                  <span class="dark:text-white"> ({AllCourses?.length})</span>
                </h5>
                <div
                  id="results-tooltip"
                  role="tooltip"
                  ...
                  {currentItems?.map((course) => {
                    return (
                      <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                        ...
                        <td>
                          <Link
                            to={`/admin/manage-course-review/${course?.id}`}
                          >
                            <button
                              type="button"
                        ...
                        <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                          <div class="flex items-center space-x-4">
                            ...
                            <Link to={`/admin/section/${course?.id}`}>
                              <button
                                type="button"
                                data-drawer-target="drawer-read-product-advanced"
                                data-drawer-show="drawer-read-product-advanced"
